...
CREATE TABLE IF NOT EXISTS leads (
  ...
  product_type TEXT NOT NULL
    CHECK(product_type IN ('Callback','Appointment')),

  solar_status TEXT NOT NULL
    CHECK(solar_status IN ('No Solar','Has Solar')),
